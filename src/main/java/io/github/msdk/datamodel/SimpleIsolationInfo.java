...
public class SimpleIsolationInfo implements IsolationInfo {
  ...
  private final @Nonnull Range<Double> isolationMzRange;
  private final @Nullable Float ionInjectTime;
  private final @Nullable Double precursorMz;
  private final @Nullable Integer precursorCharge;
  private final @Nullable ActivationInfo activationInfo;
  private final @Nullable Integer precursorScanNumber;
