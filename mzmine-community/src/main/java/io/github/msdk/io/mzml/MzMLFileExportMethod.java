 ...
 * {@link RawDataFile RawDataFile} to a file, in mzML format
 * </p>
 */
public class MzMLFileExportMethod implements MSDKMethod<Void> {
  ...
  private static final String CV_FULLNAME_MS = "Proteomics Standards Initiative Mass Spectrometry Ontology";
  private static final String CV_VERSION_MS = "4.1.136";
  private static final String CV_URI_MS = "https://raw.githubusercontent.com/HUPO-PSI/psi-ms-CV/master/psi-ms.obo";
  private static final String CV_REF_UO = "UO";
   private static final String CV_FULLNAME_UO = "Unit Ontology";
  private static final String CV_VERSION_UO = "09:04:2014";
  private static final String CV_URI_UO = "https://raw.githubusercontent.com/bio-ontology-research-group/unit-ontology/master/unit.obo";
   ...
   * </p>
   *
   * @param rawDataFile the input {@link RawDataFile RawDataFile}
   ...
   * {@link RawDataFile RawDataFile} to the target
   * {@link File File}
   * </p>
   */
  @Override
  public Void execute() throws MSDKException {
    ...
    try {
      ...
      //<cv>
      xmlStreamWriter.writeCharacters("\n      ");
      xmlStreamWriter.writeStartElement(MzMLTags.TAG_CV);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_ID, CV_REF_MS);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_FULLNAME, CV_FULLNAME_MS);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_VERSION, CV_VERSION_MS);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_URI, CV_URI_MS);
      xmlStreamWriter.writeEndElement(); // </cv>
      xmlStreamWriter.writeCharacters("\n      ");
      xmlStreamWriter.writeStartElement(MzMLTags.TAG_CV);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_ID, CV_REF_UO);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_FULLNAME, CV_FULLNAME_UO);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_VERSION, CV_VERSION_UO);
      xmlStreamWriter.writeAttribute(MzMLTags.ATTR_URI, CV_URI_UO);
      xmlStreamWriter.writeEndElement(); // </cv>

      xmlStreamWriter.writeCharacters("\n    ");
      xmlStreamWriter.writeEndElement(); // </cvList>
      ...
      // Wrapping up
      xmlStreamWriter.writeCharacters("\n");
      xmlStreamWriter.writeEndDocument(); // </indexedmzML>
      xmlStreamWriter.close();
    } catch (Exception e) {
